...
<div id="wrapper">
 	...
 	<!--banner-->
        ...
        <form action="bottle_production.php" method="POST">
  ...
  if (isset($_POST['search'])) {
    $search = mysqli_real_escape_string($con,$_POST['search']);
      $sel = "SELECT * from production_entry WHERE employee_name LIKE '%$search%' OR machine_id LIKE '%$search%' OR product_code LIKE '%$search%' OR shift LIKE '%$search%' OR preform_id LIKE '%$search%'  AND type='blow'" ;
     $run = mysqli_query($con, $sel);
  ...
  ?>
    <tr>
      ...
      <td><a class="btn btn-xs btn-success warning_4" href="edit_entry.php?id=<?php echo $id;?>">Edit</a></td>
      <td><a class="btn btn-xs btn-danger" href="bottle_production.php?id=<?php echo $id;?>">Delete</a></td>
    </tr>
  <?php }}
