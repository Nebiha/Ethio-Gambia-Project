...
<div id="wrapper">
  ...
  <h4 align="center">Cap Production Entry Edit</h4><hr>
        ...
        <form action="edit_entry_cap.php?id=<?php echo $id; ?>" method="post">
         	<div class="vali-form">
  ...
  <?php
             ...
             <div class="clearfix"> </div>
              ...
              <input style="font-size: 0.9em; color: #999; font-family: 'Muli-Regular'; 
                border: 1px solid #E9E9E9; font-size: 0.9em; padding: 0.5em 1em; color: #999;
                margin-top: 0.5em; width : 100%; font-family: 'Muli-Regular'; line-height: inherit" list="list_cap" 
                type="text" name="" required="" />
                <datalist id="list_cap">
  <?php
...
<input style="font-size: 0.9em; color: #999; font-family: 'Muli-Regular'; 
  ...
  <?php
        ...
        if (isset($_POST['update'])) {
          ...
          $update = "UPDATE production_entry SET employee_name = '$employee_name',shift='$shift',activity_date = '$activity_date',machine_id='$machine_id',cup_id='$cup_id',product_code='$product_code',product_qty='$product_qty',damaged_qty='$damaged_qty',refrence_no='$refrence_no' WHERE production_id='$edit_id'";
