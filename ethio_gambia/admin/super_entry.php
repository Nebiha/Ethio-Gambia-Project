...
<div id="wrapper">
 	...
 	<!--banner-->	
		   <div class="banner">
				...
				<span>Cap Production Entry Edit</span>
				</h2>
		    </div>
		<!--//banner-->
 	<!--grid-->
 	...
 	<!---->
  <h4 align="center">Cap Production Entry Edit</h4><hr>
  	    
        <form action="super_entry.php?id=<?php echo $id; ?>" method="POST">
         	<div class="vali-form">
	...
	<?php
		              $sel = "SELECT * FROM machine WHERE machine_type = 'CAP MAKING' ORDER BY machine_name";
             ...
             <div class="clearfix"> </div>
              <div class="col-md-6 form-group2 group-mail">
              <label class="control-label">Cap ID</label>
            <select name="cup_id" required="">
  <option value = "<?php echo $cup_id;?>"><?php echo $cup_id;?></option>
  <?php
...
<select name="product_code" required="">
	...
	<?php
        ...
        if (isset($_POST['update'])) {
          ...
          $cup_id = mysqli_real_escape_string($con,$_POST['cup_id']);
          ...
          // $insert = "INSERT INTO production_entry(employee_name,shift,activity_date,machine_id,cup_id,product_code,product_qty, damaged_qty,refrence_no, type) VALUES ('$employee_name','$shift','$activity_date','$machine_id','$cap_id','$product_code','$product_qty','$damaged_qty','$refrence_no', 'cap')";
          $insert = "INSERT INTO production_entry(production_id_edited,employee_name,shift, activity_date,machine_id,cup_id,product_code,product_qty,damaged_qty,refrence_no,type,edit,sup_username) VALUES ('$edit_id','$employee_name','$shift','$activity_date','$machine_id','$cup_id', '$product_code','$product_qty','$damaged_qty', '$refrence_no', 'cap','1','$sup_username')";
        ...
        if ($run_insert) {
           ...
           echo "<script>window.open('super_cup_production.php','_self')</script>";
