...
<div id="wrapper">
  ...
  <?php
   if (isset($_POST['search'])) {
    $search = mysqli_real_escape_string($con,$_POST['search']);
      $sel = "SELECT * from super_production_entry_update WHERE employee_name LIKE '%$search%' OR machine_id LIKE '%$search%' OR preform_id LIKE '%$search%' OR shift LIKE '%$search%'OR product_code LIKE '%$search%' AND type='injection' ORDER BY activity_date DESC " ;
  ...
  $sel = "SELECT * from super_production_entry_update WHERE type='injection' OR type='preform' ORDER BY activity_date DESC ";
  $run = mysqli_query($con, $sel);
?>
