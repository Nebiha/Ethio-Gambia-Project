...
<div id="wrapper">
 	...
 	<!--banner-->
		   <div class="banner">
				...
				<span>Blow Stock</span>
				</h2>
		    </div>
		<!--//banner-->
 	<!--grid-->
    <div class="content-top">
        <div class="banner" style="padding: 1em;">
          <h3>
        Blow Sales Entry
        </h3>
        <hr>

        <form action="blow.php" method="POST">
                <div class="input-group input-group-in" style="padding-bottom: 0em;">
                    <input name="search" class="form-control2 input-search" placeholder="Search for availabe Bottles or Jars in stock..." type="text">
  ...
  if (isset($_POST['search'])) {
    $search = mysqli_real_escape_string($con,$_POST['search']);
      $sel = "SELECT * from stock WHERE product_code LIKE '%$search%' AND product_type='Bottle' OR product_name LIKE '%$search%' AND product_type='Bottle' AND product_type='Jar' OR product_name LIKE '%$search%' AND product_type='Jar' ORDER BY available_product DESC " ;
 	 ...
 	 <div class="clearfix"> </div>
        ...
        <div class="col-md-4 ">
                ...
                <div class=" top-content">
                    <h5>Produced</h5>
                    <?php
                     $query= "SELECT SUM(product_qty), SUM(damaged_qty) from production_entry WHERE type = 'blow' OR type='Jar' AND activity_date > DATE_SUB(NOW(), INTERVAL 1 WEEK)";
                   ...
                   } ?></label><div>Bottles in 7 Days</div>
                </div>
                ...
                <div class="top-content">
                    <h5>Damaged</h5>
                     ...
                     $query= "SELECT SUM(damaged_qty) from production_entry WHERE type = 'blow' AND activity_date > DATE_SUB(NOW(), INTERVAL 1 WEEK)";
                     $result = mysqli_query($con, $query);
          ...
          <div class="col-md-4 ">
                ...
                <div class="col-md-6 top-content">
                    <h5>Remaining </h5>
                     ...
                     $sell= "SELECT SUM(available_product) from stock WHERE product_type = 'Bottle'";
         ...
         <div class="col-md-4 col-sm-12 ">
                ...
                <center>
                    <h5>Total Blow Production</h5><br><br>
                    <?php
                     $query= "SELECT SUM(product_qty), SUM(damaged_qty) from production_entry WHERE type = 'blow' AND activity_date > DATE_SUB(NOW(), INTERVAL 1 MONTH)";
                     $result = mysqli_query($con, $query);
