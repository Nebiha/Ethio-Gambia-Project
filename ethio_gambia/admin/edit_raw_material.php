...
if (isset($_GET['product_id'])) {
  ...
  $select = "select * from raw_material WHERE product_id='$edit_id'";
...
<!-- form start -->
       ...
       <h4 align="center">Add New Raw Material</h4><hr>
        
        <form action="edit_raw_material.php?product_id=<?php echo $product_id; ?>" method="post">
          <div class="vali-form">
            ...
            <div class="col-md-6 form-group1 group-mail">
              ...
              <input type="text" name="product_name" value="<?php echo $product_name ?>" placeholder="Product Name" required="">           
            </div>        
             <div class="col-md-6 form-group1 group-mail">
              <label class="control-label">Product Code</label>
              <input type="text" id="product_code" name="product_code" placeholder="Product Code" value="<?php echo $product_code ?>" required="">
              <div id="status"></div>
            </div>
            ...
            <div class="col-md-6 form-group1 group-mail">
              ...
              <input type="text" name="product_weight" placeholder="Product Weight" value="<?php echo $product_weight ?>" required="">
            </div>
        ...
        if (isset($_POST['submit'])) {
          $selemp = "SELECT * from raw_material WHERE product_id='$edit_id'";
          ...
          // privilege 
          $insert = "UPDATE raw_material SET product_code='$product_code',product_name='$product_name',product_type='$product_type',product_weight='$product_weight' WHERE product_id ='$edit_id'";
          ...
          // }
             echo "<script>alert('You have added $product_name as a new Raw Material ')</script>";
