  ...
  <h4 align="center">Cap Production Entry</h4><hr>
        ...
        <form action="cap_entry.php" method="post">
            ...
            <div class="col-md-6 form-group1 form-last">
              ...
              <input type="text" name="refrence_no" placeholder="Reference No." required="">
               <!-- <?php
             		$sel = "SELECT * FROM employee WHERE employee_id=".$_SESSION['employee_id'];
                 	  $run = mysqli_query($con,$sel);
		               while($row = mysqli_fetch_assoc($run)) {    
...
<select name="product_code" required="">
	...
	<?php
                      ...
                      $product_name=$row['product_name'];
        				echo "<option value='".$row['product_name']."|".$row['product_code']."'>".$row['product_code']. " &nbsp; | &nbsp; $product_name</option>";
        			}
		              ?>
        ...
        if (isset($_POST['submit'])) {
          ...
          if ($run_insert) { 
            ...
            while ($row=mysqli_fetch_array($run)) {
              ...
              if ($run_update_stock) {
                echo "<script>alert('$product_code You have successfully made an entry $available_product !')</script>";
