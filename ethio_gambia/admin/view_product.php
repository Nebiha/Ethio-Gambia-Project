...
<div id="wrapper">
  ...
  if (isset($_POST['search'])) {
    $search = mysqli_real_escape_string($con,$_POST['search']);
      $sel = "SELECT * from product WHERE product_name LIKE '%$search%' OR product_code LIKE '%$search%' OR product_type LIKE '%$search%' " ;
     $run = mysqli_query($con, $sel);
  ...
  <tr>
    ...
    <td><?php echo $product_name;?></td>
      ...
      <td><a class="btn btn-xs btn-success warning_4" href="edit_product.php?product_id=<?php echo $product_id;?>">Edit</a></td>
      
  <?php }}

   }else{
  $sel = "SELECT * from product order by product_type ASC";
  $run = mysqli_query($con, $sel); ?>
     <table class="table table-striped">
  <thead>
    <tr>
