...
<div id="wrapper">
  ...
  <?php
   if (isset($_POST['search'])) {
    $search = mysqli_real_escape_string($con,$_POST['search']);
      $sel = "SELECT * from super_production_entry_update WHERE employee_name LIKE '%$search%' OR machine_id LIKE '%$search%' OR cup_id LIKE '%$search%' OR shift LIKE '%$search%'OR product_code LIKE '%$search%' AND type='cap' ORDER BY activity_date DESC " ;
          $run = mysqli_query($con, $sel);
  ...
  $sel = "SELECT * from super_production_entry_update WHERE type='cap' OR type='cup' Or type='CAPS CLOSER' ORDER BY activity_date DESC ";
  $run = mysqli_query($con, $sel);
?>
