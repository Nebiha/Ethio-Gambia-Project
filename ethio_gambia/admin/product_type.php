...
<html>
<head>
<title>Ethio Gambia | Prouct Type</title>
...
<!-- form start -->
       ...
       <h4 align="center">Add Product Type</h4><hr>
        
        <form action="product_type.php" method="post">
          <div class="vali-form">            
            <div class="col-md-6 form-group1 group-mail">
              <label class="control-label">Product Type</label>
              <input type="text" name="product_name" placeholder="Product Type" required="">           
            </div>                    
            <br>
        ...
        if (isset($_POST['submit'])) {
          ...
          // privilege          
           $insert = "INSERT INTO product_type(type_name) VALUES ('$product_name')";
            $run_insert = mysqli_query($con,$insert);
          if ($run_insert) {
            echo "<script>alert('You have added $product_name as a new type of Product ')</script>";
           echo "<script>window.open('product_type.php','_self')</script>";                                
          }
          }
