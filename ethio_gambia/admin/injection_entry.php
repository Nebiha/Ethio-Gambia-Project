...
<div id="wrapper">
  ...
  if (isset($_POST['search'])) {
    $search = mysqli_real_escape_string($con,$_POST['search']);
      $sel = "SELECT * from injection WHERE preform_name LIKE '%$search%' OR preform_code LIKE '%$search%' OR reference_no LIKE '%$search%' OR activity_date LIKE '%$search%'OR employee_name LIKE '%$search%' AND product_type='injection' OR product_type='preform" ;
      $run = mysqli_query($con, $sel);
  ...
  <thead>
    <tr>
      <th scope="col">Preform Name</th>
      <th scope="col">Preform Code</th>
      <th scope="col">Qty</th>
  ...
  while ($row=mysqli_fetch_array($run)) {
      ...
      $preform_name = $row['preform_name'];
      $preform_code = $row['preform_code'];
      $qty = $row['qty'];
  ...
  ?><tbody>
    <tr>
      <td><?php echo $preform_name;?></td>
      <td><?php echo $preform_code;?></td>      
      <td><?php echo $qty;?></td>
  ...
  $sel = "SELECT * from injection where product_type='injection' OR product_type='preform' order by activity_date DESC " ; 
  $run = mysqli_query($con, $sel);
