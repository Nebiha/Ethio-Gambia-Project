...
<div id="wrapper">
 	...
 	<!--banner-->
		   <div class="banner" style="padding-bottom: 1em;">
		    	<h3>
				Edited Blow Production Entries
				</h3>
		    <hr>
  ...
  <tbody>
    <tr>
      ...
      <!-- <td><a class="btn btn-xs btn-success warning_4" href="super_edit_entry.php?id=<?php echo $id;?>">Edit</a></td> -->
    </tr>
   <?php }
    }

      }else{
  //$sel = "SELECT * from production_entry WHERE type='blow' AND production_id_edited =(SELECT production_id FROM production_entry) ORDER BY activity_date DESC";
  $sel = "SELECT * from super_production_entry_update WHERE type='blow' OR type='bottle' ORDER BY activity_date DESC ";
  $run = mysqli_query($con, $sel);
  ?>
   <table class="table table-responsive table-striped">
   <thead>
