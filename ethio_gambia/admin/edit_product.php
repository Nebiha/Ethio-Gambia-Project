...
<!-- form start -->
       ...
       <h4 align="center">Add New Product</h4><hr>
        ...
        if (isset($_POST['submit'])) {
          $selemp = "SELECT * from product WHERE product_id='$edit_id'";
          ...
          // privilege 
          $insert = "UPDATE product SET product_code='$product_code',product_name='$product_name',product_type='$product_type',product_weight='$product_weight' WHERE product_id ='$edit_id'";
