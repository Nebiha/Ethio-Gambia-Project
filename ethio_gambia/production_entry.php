...
<div id="wrapper">
  ...
  <h4 align="center">Blow Production Entry</h4><hr>
        ...
        <form action="production_entry.php" method="post">
         	<div class="vali-form">
            ...
            <div class="col-md-6 form-group1 form-last">
              ...
              <input type="text" id="refrence_no" placeholder="Reference No." required="">   
              <div id="status"></div>          
            </div>
            <div class="clearfix"> </div>
            </div>
...
<input style="font-size: 0.9em; color: #999; font-family: 'Muli-Regular'; 
	...
	<?php
        ...
        <input type="number" name="product_qty" min="0" placeholder="0" class="form-control1" id="inputSuccess1" required="">
      </div>
            <div class="col-md-6 form-group has-error">
        <label class="control-label" for="inputError1">Damaged QTY</label>
        <input type="number" name="damaged_qty" min="0" class="form-control1" id="inputError1" placeholder="0" required="">
      </div>
      <div class="col-md-6 form-group1 group-mail">
        ...
        // $product_code = mysqli_real_escape_string($con,$_POST['product_code']);
         ...
         $insert = "INSERT INTO production_entry(employee_name,shift,activity_date,machine_id,preform_id,product_code,product_qty, damaged_qty,refrence_no, type,user_date) VALUES ('$employee_name','$shift','$activity_date','$machine_id','$preform_id','$product_code','$product_qty','$damaged_qty','$refrence_no', 'blow','$user_date')";
          ...
          if ($run_insert) {
            ...
            //   if ($run_update_stock) {
              ...
              // }
           // echo "<script>alert('You have successfully made an entry!')</script>";
           // echo "<script>window.open('production_entry.php','_self')</script>";
          }
